...
public class SpawnerSystem : JobComponentSystem
{
	...
	struct SpawnJob : IJobForEachWithEntity<Spawner, Translation>
	{
		...
		public void Execute
			( Entity entity
			, int index
			, [ReadOnly] ref Spawner spawner
			, [ReadOnly] ref Translation translation
			)
		{
			s_random = new Random( spawner.seed );
			...
			{			
				...
				CommandBuffer.AddComponent(instance, new Ant { speed = randomSpeed, direction = randomDirection });
			}
